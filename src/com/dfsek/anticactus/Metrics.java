...
public class Metrics {
	...
	static {
		...
		if(System.getProperty("bstats.relocatecheck") == null || !System.getProperty("bstats.relocatecheck").equals("false")) {
			...
			// wrong
			// package names
			if(com.dfsek.anticactus.Metrics.class.getPackage().getName().equals(defaultPackage) || com.dfsek.anticactus.Metrics.class.getPackage().getName().equals(examplePackage)) {
	...
	public Metrics(Plugin plugin, int pluginId) {
		...
		if(enabled) {
			...
			Bukkit.getServicesManager().register(com.dfsek.anticactus.Metrics.class, this, plugin, ServicePriority.Normal);
			if(!found) {
				// We are the first!
				startSubmitting();
			}
